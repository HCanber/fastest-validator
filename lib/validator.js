 ...
 * @property {string} type - The message type, see https://github.com/icebob/fastest-validator#message-types
 * @property {string} [field] - The path to the field that failed validation
 * @property {string} [message] - Error description
 * @property {any} [expected] - The expected value
 * @property {any} [actual] - The actual value
 * */

/** The result returned by validate and the compiled "checker" function. 
 * Will be `true` when the provided value validates against the schema,
 * or an array of errors when the provided values did not validate against the schema.
 * @typedef {(boolean|ValidationError[])} ValidationResult */
 ...
 * @param {Object} obj
 * @param {Object} schema
 * @returns {ValidationResult} Returns `true` if valid; otherwise an array of errors
 */
...
/** The compiled "checker" function as returned by compile
 * @callback compiledChecker 
 * @param {any} value - The value to validate against the schema
 * @param {string} [path] - Optional: Path to the value
 * @param {any} [parent] - Optional: The parent of the value
 * @returns {ValidationResult} - Returns `true` when the value validates against the schema;
 ...
 *
 * @param {Object} schema
 * @returns {compiledChecker} Returns a compiled "checker" function that given a value returns 
 *   `true` if it  validated against the schema, or if it failed an array of errors
